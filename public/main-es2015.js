...
/* harmony import */ var _data_resolver_service__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./data-resolver.service */ "./src/app/data-resolver.service.ts");
...
const routes = [
    ...
    {
        path: 'finishedHabits',
        loadChildren: () => __webpack_require__.e(/*! import() | pages-finishedHabits-finishedHabits-module */ "pages-finishedHabits-finishedHabits-module").then(__webpack_require__.bind(null, /*! ./pages/finishedHabits/finishedHabits.module */ "./src/app/pages/finishedHabits/finishedHabits.module.ts")).then(m => m.FinishedHabitsPageModule)
    },
    {
        path: 'urgentToDos',
        loadChildren: () => __webpack_require__.e(/*! import() | pages-urgentToDos-urgentToDos-module */ "pages-urgentToDos-urgentToDos-module").then(__webpack_require__.bind(null, /*! ./pages/urgentToDos/urgentToDos.module */ "./src/app/pages/urgentToDos/urgentToDos.module.ts")).then(m => m.UrgentToDosPageModule)
    },
    {
        path: 'laterToDos',
        loadChildren: () => __webpack_require__.e(/*! import() | pages-laterToDos-laterToDos-module */ "pages-laterToDos-laterToDos-module").then(__webpack_require__.bind(null, /*! ./pages/laterToDos/laterToDos.module */ "./src/app/pages/laterToDos/laterToDos.module.ts")).then(m => m.LaterToDosPageModule)
    },
    {
        path: 'doneToDos',
        loadChildren: () => __webpack_require__.e(/*! import() | pages-doneToDos-doneToDos-module */ "pages-doneToDos-doneToDos-module").then(__webpack_require__.bind(null, /*! ./pages/doneToDos/doneToDos.module */ "./src/app/pages/doneToDos/doneToDos.module.ts")).then(m => m.DoneToDosPageModule)
    },
    {
        path: 'login',
        loadChildren: () => Promise.resolve(/*! import() */).then(__webpack_require__.bind(null, /*! ./pages/login/login.module */ "./src/app/pages/login/login.module.ts")).then(m => m.LoginPageModule)
    },
    {
        path: 'tos',
    ...
    {
        path: 'detail',
        loadChildren: () => Promise.resolve(/*! import() */).then(__webpack_require__.bind(null, /*! ./pages/detail/detail.module */ "./src/app/pages/detail/detail.module.ts")).then(m => m.DetailPageModule)
    },
    {
        path: 'detail/:id',
        resolve: {
    ...
    },
    {
        ...
        loadChildren: () => __webpack_require__.e(/*! import() | finished-detail-finished-detail-module */ "finished-detail-finished-detail-module").then(__webpack_require__.bind(null, /*! ./finished-detail/finished-detail.module */ "./src/app/finished-detail/finished-detail.module.ts")).then(m => m.FinishedDetailPageModule)
    }
];
...
let AppComponent = class AppComponent {
    constructor(platform, splashScreen, statusBar, afAuth, modalCtrl, router) {
...
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _pages_detail_detail_module__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./pages/detail/detail.module */ "./src/app/pages/detail/detail.module.ts");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/__ivy_ngcc__/fesm2015/core.js");
...
/* harmony import */ var _pages_login_login_module__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./pages/login/login.module */ "./src/app/pages/login/login.module.ts");
/* harmony import */ var _ionic_native_local_notifications_ngx__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! @ionic-native/local-notifications/ngx */ "./node_modules/@ionic-native/local-notifications/__ivy_ngcc__/ngx/index.js");
/* harmony import */ var _angular_fire_messaging__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! @angular/fire/messaging */ "./node_modules/@angular/fire/__ivy_ngcc__/fesm2015/angular-fire-messaging.js");
...
AppModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
        ...
        imports: [
            ...
            _pages_login_login_module__WEBPACK_IMPORTED_MODULE_14__["LoginPageModule"],
            _pages_detail_detail_module__WEBPACK_IMPORTED_MODULE_1__["DetailPageModule"],
...
let DetailPage = class DetailPage {
    constructor(navCtrl, afAuth, db, router, route, navParams, alertCtrl) {
        ...
        this.onTimeSelected = (ev) => {
            ...
            let date = new Date(Object(date_fns__WEBPACK_IMPORTED_MODULE_7__["getYear"])(ev.selectedTime), ev.selectedTime.getMonth(), ev.selectedTime.getDate());
                    ...
                    buttons: [
                        {
                            text: 'tak',
                            handler: () => {
                                const increment = firebase__WEBPACK_IMPORTED_MODULE_8__["firestore"].FieldValue.increment(1);
        ...
        this.markDisabled = (date) => {
            ...
            let endDate = Object(date_fns__WEBPACK_IMPORTED_MODULE_7__["addDays"])(startDate, (this.habit.duration));
...
], DetailPage.prototype, "myCal", void 0);
...
/* harmony import */ var firebaseui_dist_npm_pl__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! firebaseui/dist/npm__pl */ "./node_modules/firebaseui/dist/npm__pl.js");
/* harmony import */ var firebaseui_dist_npm_pl__WEBPACK_IMPORTED_MODULE_7___default = /*#__PURE__*/__webpack_require__.n(firebaseui_dist_npm_pl__WEBPACK_IMPORTED_MODULE_7__);
/* harmony import */ var _login_page__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./login.page */ "./src/app/pages/login/login.page.ts");
...
const firebaseUiAuthConfig = {
    signInFlow: 'popup',
    signInOptions: [
        firebaseui_angular__WEBPACK_IMPORTED_MODULE_6__["firebase"].auth.EmailAuthProvider.PROVIDER_ID,
    ],
    tosUrl: '/tos',
...
LoginPageModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        imports: [
            ...
            firebaseui_angular__WEBPACK_IMPORTED_MODULE_6__["FirebaseUIModule"].forRoot(firebaseUiAuthConfig)
        ],
...
module.exports = __webpack_require__(/*! C:\Users\MK\Desktop\projekt\HabitTracker\src\main.ts */"./src/main.ts");
